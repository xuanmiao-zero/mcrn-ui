...
import com.mcrnui.utils.SentryUtil;
import com.mcrnui.utils.ToastUtils;
...
import static com.mcrnui.base.Constants.JS_BUNDLE_FILE_NAME;
...
public class DownloadService extends IntentService {
    ...
    public final static String NOTIFI_TITLE = "mcrnui";
    public final static String NOTIFI_DESC = "mcrnui";
    ...
    public DownloadService() {
        ...
        File file = MainApplication.getInstance().getExternalFilesDir(FILE_PATH);
        if (file != null) {
        ...
        if (!TextUtils.isEmpty(url)) {
            ...
            if (downloader != null) {
                ...
                if (cur.moveToFirst()) {
                    ...
                    task.setTitle(NOTIFI_TITLE);
                    task.setDescription(NOTIFI_DESC);
...
//      安装完成后，启动app（源码中少了这句话）
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            uri = FileProvider.getUriForFile(this, "com.mcrnui.fileProvider", apkFile);
