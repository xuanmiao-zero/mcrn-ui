...
public class ToastUtils {
    ...
    public static void showToast(final CharSequence msg) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                TextView view = new TextView(MainApplication.getInstance());
                view.setText(msg);
                view.setTextColor(Color.WHITE);
                view.setBackgroundResource(R.drawable.bg_shape_toast);
                int padding = DisplayUtil.dip2px(MainApplication.getInstance(), 5);
    ...
    public static void showToast(@StringRes int resId) {
        showToast(MainApplication.getInstance().getString(resId));
    }
