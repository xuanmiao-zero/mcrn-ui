...
import com.mcrnui.R;
import com.mcrnui.base.BaseActivity;
import com.mcrnui.bean.EnvBean;
...
public class EnvironmentSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerview.setAdapter(new EnvironmentSettingAdapter(SharedPreferencesUtil.getEnvList()));
    }
    ...
    class EnvironmentSettingAdapter extends RecyclerView.Adapter {
        ...
        public EnvironmentSettingAdapter(EnvBean bean) {
        ...
        class EnvironmentSettingViewHolder extends RecyclerView.ViewHolder {
            ...
            public EnvironmentSettingViewHolder(View itemView) {
                super(itemView);
            ...
            @OnClick({R.id.check_box, R.id.env_text})
            public void click_checked(View view) {
                ...
                SharedPreferencesUtil.setEnvSelected(envStr);
                SharedPreferencesUtil.saveEnvBean(new EnvBean(data));
                AppUtil.restartApp();
            }
        }
    }
